...
if(isset($_POST['form1'])) {
	...
	if($_SESSION['user']['role'] == 'Admin') {
	    ...
	    if(empty($_POST['full_name'])) {
	        $valid = 0;
	        $error_message .= "Artist name can not be empty<br>";
	    }
	    ...
	    if($valid == 1) {
	    	...
	    	$success_message = 'Artist Information updated successfully.';
	    }
	}
	else {
...
if(isset($_POST['form2'])) {
    ...
    if($path!='') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' ) {
            $valid = 0;
            $error_message .= 'You must have to upload jpg, jpeg or png file<br>';
        }
    }
    ...
    if($valid == 1) {
    	...
    	// updating the data
    	$final_name = 'artist-'.$_SESSION['user']['id'].'.'.$ext;
        ...
        $success_message = 'Artist Profile picture updated successfully.';
...
if(isset($_POST['form3'])) {
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Artist Password is updated successfully.';
    }
}
?>
					...
					<div class="tab-content">
          				<div class="tab-pane active" id="tab_1">
							...
							<div class="box box-info">
								<div class="box-body">
									...
									<div class="form-group">
							            <label for="" class="col-sm-2 control-label">Existing profile picture</label>
          				...
          				<div class="tab-pane" id="tab_2">
							...
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
							            <label for="" class="col-sm-2 control-label">New profile picture</label>
							            <div class="col-sm-6" style="padding-top:6px;">
							        ...
							        <div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form2">Update picture</button>
										</div>
									</div>
								</div>
							</div>
