...
<head>
	...
	<title>Arewa Global Main - Login Panel</title>
...
<div class="login-box">
		...
		<img align="middle" class="lll" src="img/logo.png" alt="Arewa Global Admin Panel">
	
  	<div class="login-box-body">
    	<p class="login-box-msg">Welcome back to Admin panel, uses your Email and Password to login</p>
